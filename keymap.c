...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(KC_KP_7, KC_KP_8, KC_KP_9,
									KC_KP_4, KC_KP_5, KC_KP_6,
									KC_KP_1, KC_KP_2, LT(_NUMPAD, KC_KP_3)),

  [_NUMPAD] = LAYOUT(	KC_TRNS, KC_TRNS, KC_TRNS, 
								      KC_TRNS, TG(_ARROWS), KC_TRNS, 
								      TG(_MUSIC), KC_KP_0, KC_TRNS),

	[_MUSIC] = LAYOUT(KC_TRNS, KC_AUDIO_VOL_UP, TO(_BASE), 
								  	KC_MEDIA_PREV_TRACK, KC_MEDIA_PLAY_PAUSE, KC_MEDIA_NEXT_TRACK, 
								  	KC_TRNS, KC_AUDIO_VOL_DOWN, LT(_NUMPAD, KC_TRNS)),

  [_ARROWS] = LAYOUT(	TO(_MUSIC), KC_TRNS, TO(_BASE), 
								      KC_DELETE, KC_UP, KC_TRNS, 
								      KC_LEFT, LT(_ARROWS2, KC_DOWN), KC_RIGHT),

	[_ARROWS2] = LAYOUT(	TO(_MUSIC), KC_TRNS, TO(_BASE), 
